...
Call the function in a terminal located in the directory of the calc_pt_image_opk.py file. To view the information on the various parameters you can do : 

```python calc_pt_image_opk.py -h``` 
...
E.G.
```
python3 ./calc_pt_image_opk.py -r ./dataset/23FD1305_alt_test.OPK -i NXYZOPKC -f 2 -c ./dataset/Camera1.txt -e 2154 -y ./dataset/fr_ign_RAF20.tif -m ./dataset/MNT_France_25m_h_crop.tif --fm height -t ./dataset/terrain_test0.mes -g ./dataset/GCP_test.app --fg height -n Coor2d_pt_terrain -w ./test/tmp/
```
