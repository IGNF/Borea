...
from src.transform_world_image.transform_worksite.image_world_least_squart import WorldLeastSquart
    ...
    def manage_image_world(self, type_point: str = "co_points", type_process: str = "intersection",
        ...
        Args:
            ...
            type_process (str): Type of process you want to use.
                                ...
                                * "least_squart" take all point and do methode.
        ...
        if type_process not in ["intersection", "least_squart"]:
            raise ValueError(f"type_process {type_process} is incorrect, "
                             "['intersection','least_squart']")
        ...
        if type_process == "least_squart":
            WorldLeastSquart(self.work).compute_image_world_least_square(type_point, control_type)
