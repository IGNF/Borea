# README to convert opk to conical file for GEOVIEW IGN

Converts an opk file into an conical file (.CON). This format is an xml format for GEOVIEW. It's a IGN France software to view image.

## Utilisation

### Terminal use

Call the function in a terminal located in the directory of the opk_to_conical.py file. To view the information on the various parameters you can do : 

```python opk_to_conical.py -h``` 
...
E.G.
```
python3 ./opk_to_conical.py -r ./dataset/23FD1305_alt_test.OPK -i NXYZOPKC -f 2 -e 2154 -y ./dataset/fr_ign_RAF20.tif -c ./dataset/Camera1.txt -m ./dataset/MNT_France_25m_h_crop.tif --fm height -w ./test/tmp/
```
