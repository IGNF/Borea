...
def space_resection(shot: Shot, cam: Camera, proj: ProjEngine, dtm: Dtm, type_z_data: str,
    ...
    x_world, y_world, _ = shot.image_z_to_world(c_obs, l_obs, cam, dtm, type_z_shot, z_world)
    ...
    while bool_iter:
        ...
        c_f0, l_f0 = shot_adjust.world_to_image(x_world, y_world, z_world, cam, dtm,
