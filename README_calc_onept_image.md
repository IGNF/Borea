...
Call the function in a terminal located in the directory of the calc_pt_image.py file. To view the information on the various parameters you can do : 

```python calc_pt_image.py -h``` 
...
E.G.
```
python3 ./calc_pt_image.py -n Test -s 814975.925 6283986.148 1771.280 -t altitude -o -0.245070686036 -0.069409621323 0.836320989726 -b opk -u degree -a True -e 2154 -y ./dataset/fr_ign_RAF20.tif -c ./dataset/Camera1.txt -m ./dataset/MNT_France_25m_h_crop.tif --fm height -p 24042.25 14781.17 -d height
```
