...
work.add_shot("shot1",np.pmatrix([814975.925,6283986.148,1771.280]),np.pmatrix([-0.245070686036,-0.069409621323,0.836320989726]),"cam_test","degree", True)
work.add_shot("shot2",np.pmatrix([814977.593,6283733.183,1771.519]),np.pmatrix([-0.190175545509,-0.023695590794,0.565111690487]),"cam_test","degree", True)
